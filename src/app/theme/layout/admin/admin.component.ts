...
export class AdminComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.router.events.pipe(
      ...
      if (event.url === '/home/dashboard' || event.url === '/home/report' || event.url === '/home/pravaslist' || event.url ==='/home/vahivat' || event.url ==='/login' || event.url === '/home/jillavrut' || event.url === '/home/sevadarshan' || event.url === '/home/tempadmin'  || event.url.includes('/home/sevadarshan-vrut') || event.url === '/home/manage-user') {
