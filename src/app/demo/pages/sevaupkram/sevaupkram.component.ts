...
export class SevaupkramComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.apiService.postData('api/sevaUpkram',obj).subscribe((res:any)=>{
      alert(res)
    })
...
@Component({
  selector: 'app-n-seva-upkram',
  templateUrl: './n-seva-upkram.component.html',
  styleUrls: ['./n-seva-upkram.component.scss'],
})
export class NSevaUpkramComponent implements OnInit {
  dynamicForm: any;
  data = {};
  selectedYear:any="";
  selectedMonth:any="";
