...
export class SevaKaryaComponent {
  ...
  isFilled(item: any): boolean {
    return (
      this.checkedItems[item.name]?.men ||
  ...
  isOthersFilled(category: string): any {
    if (category === 'shiksha')
      return (
        this.othersShiksha.men ||
        this.othersShiksha.women ||
        this.othersShiksha.others
      );
    if (category === 'aayogya')
      return (
        this.othersAayogya.men ||
        this.othersAayogya.women ||
        this.othersAayogya.others
      );
    if (category === 'sawval')
      return (
        this.othersSawval.men ||
        this.othersSawval.women ||
        this.othersSawval.others
      );
    if (category === 'samajik')
      return (
        this.othersSamajik.men ||
        this.othersSamajik.women ||
        this.othersSamajik.others
      );
    return false;
  }
